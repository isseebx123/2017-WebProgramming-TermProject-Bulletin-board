	...
	<main>
		...
		<table>
			...
			<tbody>
				...
				String stringTags = dbBoardLoad.getBoardRecordsWithCriteriaAndKeyword("FreeBoard", CRITERIA, KEYWORD);
		...
		<br/>
		<form action="./TP2_03_FreeBoard.jsp" method="get">
		...
		href="<%
				...
				else{ out.print("./TP2_07_NewWrite.jsp?boardname=FreeBoard"); }
			 %>">게시물등록</a>
	</main>
		<!-- footer 시작 -->
	<footer>
