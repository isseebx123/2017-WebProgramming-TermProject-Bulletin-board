...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/TP2_10_BOARD_CSS.css">
	...
	<main>
		...
		<table>
			...
			<tbody>
				...
				String stringTags = dbBoardLoad.getBoardRecordsWithCriteriaAndKeyword("AnonymousBoard", CRITERIA, KEYWORD);
		...
		<br/>
		<form action="./TP2_02_AnonymousBoard.jsp" method="get">
		...
		href="<%
				...
				else{ out.print("./TP2_07_NewWrite.jsp?boardname=AnonymousBoard"); }
			 %>">게시물등록</a>
	</main>
		<!-- footer 시작 -->
	<footer>
